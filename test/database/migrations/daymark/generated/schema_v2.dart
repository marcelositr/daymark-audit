...
class Trackers extends Table with TableInfo<Trackers, TrackersData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TrackersData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TrackersData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class TrackersData extends DataClass implements Insertable<TrackersData> {
  final String id;
  final String title;
  ...
  factory TrackersData.fromJson(
    ...
    return TrackersData(
      ...
      plannedEndDate: serializer.fromJson<String>(json['plannedEndDate']),
      endedDate: serializer.fromJson<String?>(json['endedDate']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'plannedEndDate': serializer.toJson<String>(plannedEndDate),
      'endedDate': serializer.toJson<String?>(endedDate),
  ...
  TrackersData copyWithCompanion(TrackersCompanion data) {
    return TrackersData(
      id: data.id.present ? data.id.value : this.id,
      title: data.title.present ? data.title.value : this.title,
  ...
  @override
  String toString() {
    return (StringBuffer('TrackersData(')
          ..write('id: $id, ')
          ..write('title: $title, ')
...
class TrackersCompanion extends UpdateCompanion<TrackersData> {
  final Value<String> id;
  final Value<String> title;
  ...
  TrackersCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<TrackersData> custom({
    Expression<String>? id,
    Expression<String>? title,
...
class TrackerMarks extends Table
    with TableInfo<TrackerMarks, TrackerMarksData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  TrackerMarksData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TrackerMarksData(
...
class TrackerMarksData extends DataClass
    implements Insertable<TrackerMarksData> {
  final String trackerId;
  final String methodDate;
  final int value;
  final int createdAt;
  final int updatedAt;
  const TrackerMarksData({
  ...
  factory TrackerMarksData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TrackerMarksData(
      ...
      methodDate: serializer.fromJson<String>(json['methodDate']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'methodDate': serializer.toJson<String>(methodDate),
  ...
  TrackerMarksData copyWithCompanion(TrackerMarksCompanion data) {
    return TrackerMarksData(
  ...
  @override
  String toString() {
    return (StringBuffer('TrackerMarksData(')
...
class TrackerMarksCompanion extends UpdateCompanion<TrackerMarksData> {
  ...
  TrackerMarksCompanion.insert({
    ...
    required int updatedAt,
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<TrackerMarksData> custom({
